...
namespace Broccoli.Manager
{
	...
	public class MeshManager {
		...
		public Mesh MergeAll (Transform transform) {
			...
			if (GlobalSettings.experimentalAO) {
			}
			...
			if (GlobalSettings.experimentalAO) {
				...
				Broccoli.Utils.AmbientOcclusionBaker.BakeAO (
					...
					triangles.GetRange (0, branchTrisLength).ToArray (),
					triangles.GetRange (branchTrisLength, triangles.Count - branchTrisLength).ToArray (),
