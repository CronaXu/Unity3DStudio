	...
	public class BranchMeshGeneratorComponent : TreeFactoryComponent {
		...
		private void BuildMesh (TreeFactory treeFactory, int pass) {
			...
			if (trunkMeshGeneratorElement != null && trunkMeshGeneratorElement.isActive) {
				CreateTrunkMeshBuilder (trunkMeshGeneratorElement, treeFactory, pass);
			}
			...
			{
				CreateShapeMeshBuilder (treeFactory, pass);
			}
			...
			if (branchMeshGeneratorElement.meshMode == BranchMeshGeneratorElement.MeshMode.Default &&
				...
				CreateWeldingMeshBuilder (treeFactory, pass);
			}
		...
		private void CreateTrunkMeshBuilder (TrunkMeshGeneratorElement trunkMeshGeneratorElement, TreeFactory treeFactory, int pass) {
			...
			trunkMeshBuilder.lengthPosResolution = trunkMeshGeneratorElement.lengthPosResolution / pass;
		...
		/// </summary>
		/// <param name="treeFactory">Tree factory instance.</param>
		/// <param name="pass">Pass on the factory.</param>
		private void CreateWeldingMeshBuilder (TreeFactory treeFactory, int pass) {
			// Register the welding mesh builder.
			WeldingMeshBuilder weldingMeshBuilder = new WeldingMeshBuilder ();
			weldingMeshBuilder.pass = pass;

			// Properties for branches.
			weldingMeshBuilder.useBranchWelding = branchMeshGeneratorElement.useBranchWelding;
			...
			weldingMeshBuilder.useRootWelding = branchMeshGeneratorElement.useRootWelding;
